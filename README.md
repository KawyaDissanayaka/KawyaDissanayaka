...
💡 I am a passionate Full-stack Developer skilled in building end-to-end applications. I focus on writing clean, efficient code and creating beautiful UI/UX experiences.
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3>🐾 Street Dog Care Portal</h3>
      <p>Modern management system for animal shelters built with <b>Next.js, Node.js, and MongoDB</b>.</p>
      <a href="https://github.com/KawyaDissanayaka/Street-Dog-Care-Management-System.git"><b>View Repository</b></a>
    </td>
    <td width="50%" valign="top">
      <h3>🧠 AI Medical Chatbot</h3>
      <p>Python-based symptom analysis assistant utilizing <b>RESTful APIs</b> and Gemini.</p>
      <a href="https://github.com/KawyaDissanayaka/Medical_ChatBot.git"><b>View Repository</b></a>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>🧺 Laundry Management System</h3>
      <p>Full-stack pickup and delivery system built using <b>Spring Boot</b> and <b>React</b>.</p>
      <a href="https://github.com/KawyaDissanayaka/laundry-pickup-delivery-management-system-frontend.git"><b>View Repository</b></a>
    </td>
    <td width="50%" valign="top">
      <h3>🏫 Skills International School</h3>
      <p>Web platform integrated with <b>SQL database</b> for school management.</p>
      <a href="https://github.com/Kavindi52/Skills-International-School-webpage.git"><b>View Repository</b></a>
    </td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h4>🏫 Education</h4>
      <ul>
        <li><b>BSc (Hons) Computer Science</b><br>NSBM Green University (2025 - Present)</li>
        <li><b>Diploma in IT & English</b><br>ESOFT Metro Campus (2023)</li>
        <li><b>Advanced Level (Bio Science)</b><br>Kegalu Balika Vidyalaya (2019-2021)</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h4>🏆 Certifications</h4>
      <ul>
        <li><b>C++ Essentials (Basic-Advanced)</b><br>Cisco Network Academy</li>
        <li><b>English Language Certifications</b><br>Britishway English Academy</li>
        <li><b>Professional Communication</b><br>ESOFT Metro Campus</li>
      </ul>
    </td>
  </tr>
</table>
...
<p align="left">
  ...
  <img src="https://cdn.worldvectorlogo.com/logos/next-js.svg" width="40" height="40" title="Next.js"/>
